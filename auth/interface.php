...
echo "	<meta property='og:locale' content='nl_NL'>".NL;
echo "	<meta property='og:site_name' content='". $ScriptTitle ."'>".NL;
echo "	<meta property='og:type' content='article'>".NL;
echo "	<meta property='og:title' content='". ((isset($pageTitle) && $pageTitle != '') ? $pageTitle : '') ."'>".NL;
echo "	<meta property='og:description' content='Intranet van de Koningskerk in Deventer'>".NL;
echo "	<meta property='og:url' content='". $ScriptServer.$_SERVER['PHP_SELF'] ."'>".NL;
echo "	<meta property='og:image' content='". $ScriptURL ."images/logoKoningsKerk.png'>".NL;
echo "</head>".NL;
echo "<body>".NL;
