<?php
require('3gk_declaratie_pdf.php');

class PDF_3GK_Table_Declaratie extends PDF_3GK_Declaratie {
	var $widths;
	var $aligns;
	...
	function Row($data, $fill) {
		...
		for($i=0;$i<count($data);$i++) {
			...
			# Print the text
			$this->MultiCell($w,5, iconv("UTF-8", "CP1252", $data[$i]),0,$a);
