...
if(isset($_REQUEST['voorgangerID'])) {
	...
	if(in_array(1, getMyGroups($_SESSION['ID']))) {	
		...
		$text[] = "	<td><input type='text' name='honorarium_old' value='". $voorgangerData['honorarium_oud'] ."'></td>";
		$text[] = "</tr>";
		$text[] = "<tr>";
		$text[] = "	<td>Honorarium 2020</td>";
		$text[] = "	<td><input type='text' name='honorarium_new' value='". $voorgangerData['honorarium_nieuw'] ."'></td>";
		$text[] = "</tr>";
		$text[] = "<tr>";
		$text[] = "	<td>Honorarium<br><small>speciale gelegenheden</small></td>";
		$text[] = "	<td><input type='text' name='honorarium_spec' value='". $voorgangerData['honorarium_spec'] ."'></td>";
		$text[] = "</tr>";
		$text[] = "<tr>";
